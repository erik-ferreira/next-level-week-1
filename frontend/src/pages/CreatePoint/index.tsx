...
const CreatePoint = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get<CityProps[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
      .then(response => {
  ...
  function MyComponent() {
    useMapEvents({
      click: updatePositionMarker
    })
    return null
  }

  function updatePositionMarker(event: LeafletMouseEvent) {
    setSelectedPosition([
      event.latlng.lat,
      event.latlng.lng
    ])
